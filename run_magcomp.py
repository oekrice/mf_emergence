...
#This particular one has lots of outputs, so can be compared directly against the reference
...
if run == 0:  #For hmatch comparison
    print('Running hmatch comparison')
    init_number = 800
else:
    print('Running bmatch comparison')
    init_number = 900   #For bmatch comparison
