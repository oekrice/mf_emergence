...
#This run is for diagnostic and field line plotting, using the electric field input from the 'smart' omega tracing. Designed for Hamilton and can't have many outputs.
